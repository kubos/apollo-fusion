...
// If it's not, send a distress beacon over the duplex
...
fn send_error() -> Result<(), Error> {
    ...
    let config = ServiceConfig::new("nsl-duplex-comms-service");
    ...
    // TODO: Maybe don't hard code the downlink port number
